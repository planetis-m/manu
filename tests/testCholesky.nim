import math, testutils, morpheus / [matrix, cholesky]
...
block:
   ...
   try:
      ...
      try_success("CholeskyDecomposition 2x2...", "")
   except ValueError:
      try_failure(errorCount,"CholeskyDecomposition 2x2...",
...
block:
   ...
   try:
      check(l * l.transpose, mat)
      try_success("CholeskyDecomposition 3x3...", "")
   except ValueError:
      try_failure(errorCount,"CholeskyDecomposition 3x3...",
                  "incorrect Cholesky decomposition calculation")
...
block:
   ...
   try:
      check(l * l.transpose, mat)
      try_success("CholeskyDecomposition 4x4...", "")
   except ValueError:
      try_failure(errorCount,"CholeskyDecomposition 4x4...",
                  "incorrect Cholesky decomposition calculation")
...
block:
   ...
   try:
      check(l * l.transpose, mat)
      try_success("CholeskyDecomposition 5x5...", "")
   except ValueError:
      try_failure(errorCount,"CholeskyDecomposition 5x5...",
                  "incorrect Cholesky decomposition calculation")
