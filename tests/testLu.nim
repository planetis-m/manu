...
block:
   ...
   try:
      ...
      try_success("LUDecomposition 2x2...", "")
   except ValueError:
      try_failure(errorCount,"LUDecomposition 2x2...",
...
block:
   ...
   try:
      check(mat[lu.getPivot, 0 ..< mat.n], lu.getL * lu.getU)
      try_success("LUDecomposition 3x3...", "")
   except ValueError:
      try_failure(errorCount,"LUDecomposition 3x3...",
                  "incorrect LU decomposition calculation")
...
block:
   ...
   try:
      check(mat[lu.getPivot, 0 ..< mat.n], lu.getL * lu.getU)
      try_success("LUDecomposition 3x3_2...", "")
   except ValueError:
      try_failure(errorCount,"LUDecomposition 3x3_2...",
                  "incorrect LU decomposition calculation")
...
block:
   ...
   try:
      check(mat[lu.getPivot, 0 ..< mat.n], lu.getL * lu.getU)
      try_success("LUDecomposition 4x4...", "")
   except ValueError:
      try_failure(errorCount,"LUDecomposition 4x4...",
                  "incorrect LU decomposition calculation")
...
block:
   ...
   try:
      check(mat[lu.getPivot, 0 ..< mat.n], lu.getL * lu.getU)
      try_success("LUDecomposition 5x5...", "")
   except ValueError:
      try_failure(errorCount,"LUDecomposition 5x5...",
                  "incorrect LU decomposition calculation")
...
block:
   ...
   try:
      check(mat[lu.getPivot, 0 ..< mat.n], lu.getL * lu.getU)
      try_success("LUDecomposition 5x5_2...", "")
   except ValueError:
      try_failure(errorCount,"LUDecomposition 5x5_2...",
                  "incorrect LU decomposition calculation")
